...
#define BSP_CFG_PLL2_MUL BSP_CLOCKS_PLL_MUL(266,0) /* PLL2 Mul x260-279|Mul x266|PLL2 Mul x266.00 */
#define BSP_CFG_PLL2_FREQUENCY_HZ (2128000000) /* PLL2 2128000000Hz */
#define BSP_CFG_PL2ODIVP (BSP_CLOCKS_PLL_DIV_2) /* PLL2P Div /2 */
#define BSP_CFG_PLL2P_FREQUENCY_HZ (1064000000) /* PLL2P 1064000000Hz */
#define BSP_CFG_PL2ODIVQ (BSP_CLOCKS_PLL_DIV_8) /* PLL2Q Div /8 */
#define BSP_CFG_PLL2Q_FREQUENCY_HZ (266000000) /* PLL2Q 266000000Hz */
#define BSP_CFG_PL2ODIVR (BSP_CLOCKS_PLL_DIV_5) /* PLL2R Div /5 */
#define BSP_CFG_PLL2R_FREQUENCY_HZ (425600000) /* PLL2R 425600000Hz */
...
#define BSP_CFG_BCLKA_DIV (BSP_CLOCKS_BCLKA_CLOCK_DIV_2) /* BCLKA Div /2 */
...
#define BSP_CFG_CANFDCLK_SOURCE (BSP_CLOCKS_SOURCE_CLOCK_PLL1R) /* CANFDCLK Src: PLL1R */
...
#define BSP_CFG_LCDCLK_SOURCE (BSP_CLOCKS_SOURCE_CLOCK_PLL1R) /* LCDCLK Src: PLL1R */
...
#define BSP_CFG_UCLK_DIV (BSP_CLOCKS_USB_CLOCK_DIV_8) /* USBCLK Div /8 */
...
#define BSP_CFG_OCTACLK_SOURCE (BSP_CLOCKS_SOURCE_CLOCK_PLL2Q) /* OCTACLK Src: PLL2Q */
#define BSP_CFG_OCTACLK_DIV (BSP_CLOCKS_OCTA_CLOCK_DIV_1) /* OCTACLK Div /1 */
#define BSP_CFG_ADCCLK_SOURCE (BSP_CLOCKS_SOURCE_CLOCK_PLL1R) /* ADCCLK Src: PLL1R */
...
#define BSP_CFG_ETHPHYCLK_SOURCE (BSP_CLOCKS_SOURCE_CLOCK_PLL1R) /* ETHPHYCLK Src: PLL1R */
#define BSP_CFG_ETHPHYCLK_DIV (BSP_CLOCKS_ETHPHY_CLOCK_DIV_8) /* ETHPHYCLK Div /8 */
